...
export default function NavBar(){
	...
	return(<>
		<nav class="bottom" role="navigation" aria-label="navigation">
			<div class="nav">
				<Link class="sidebutton" href="/list"><div class="stack"><img class="sideImg journ" src="https://cdn-icons-png.flaticon.com/512/3221/3221593.png"></img><p>Journal</p></div></Link> 
