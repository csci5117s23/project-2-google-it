    ...
    <>
      ...
      <div style={{display:"flex", alignItems:"center"}}>
        <div style={{flexBasis:"30%", paddingLeft:"0.5em"}}>
          <Link href="/list" style={{display:"flex", flexDirection:"row", alignItems:"center"}}>
            <div style={{display:"flex", flexDirection:"row", alignItems:"center"}}>
              ...
              <div style={{fontSize:"calc(6px + 2vmin)", paddingRight:"6px"}}>Journal</div>
            </div>
          </Link>
        </div>
        <div style={{flexGrow: 3, textAlign: "center", fontSize: "calc(5px + 2vmin)"}}>
          <b>Your Bevary Entries For: </b>{name}
        </div>
        <div style={{flexBasis:"30%"}}> </div>
      </div>
      <div className="fadeIn" style={{paddingTop:"4px"}}>
